...
class CipherSuiteCCM8UnitTests(TestCase):
    ...
    def test_member_attributes(self):
        ...
        self.assertEqual(cs.enc_algorithm.__str__(), 'AES 256 CCM 8')
        self.assertEqual(cs.hash_algorithm.__str__(), 'SHA256')


class CipherSuitePSKDHEUnitTests(TestCase):
    cipher_suite = 'TLS_PSK_DHE_WITH_AES_256_CCM_8'
